...
const layout = {{
  annotations: [
    ...
    {{
      text: 'Dispersive Wave<br>generation',
      x: 295, y: 0.30, xref: 'x', yref: 'y',
      ax: 50, ay: -40,
      showarrow: true, arrowhead: 2, arrowsize: 1, arrowwidth: 1, arrowcolor: '#1565C0',
      font: {{size: 11, color: '#1565C0', family: 'Lato, sans-serif'}},
      align: 'center',
    }},
    {{
      text: 'Soliton Self<br>Compression',
      x: 0, y: 0.6, xref: 'x2', yref: 'y2',
      ax: 52, ay: -28,
      showarrow: true, arrowhead: 2, arrowsize: 1, arrowwidth: 1, arrowcolor: '#1565C0',
      font: {{size: 11, color: '#1565C0', family: 'Lato, sans-serif'}},
      align: 'center',
  ...
  shapes: [
    {{
      ...
      x0: 200, x1: 300, y0: 0, y1: 1,
      fillcolor: 'rgba(21,101,192,0.10)', line: {{width: 0}}, layer: 'below',
    }},
  ],
  xaxis: {{
    domain: [0, 0.46],
